...
#ifndef __BOARDS_ARM_AT32_AT32F4DISCOVERY_SRC_AT32F4DISCOVERY_H
#define __BOARDS_ARM_AT32_AT32F4DISCOVERY_SRC_AT32F4DISCOVERY_H
...
#if !defined(CONFIG_NET) || !defined(CONFIG_AT32_EMACMAC)
...
/* The NSH Network Monitor cannot be used with the AT32F4DIS-BB base board.
...
/* SPI1 W25QXX */
#define W25QXX_FLASH_MINOR  0   //w25qxx设备号
...
/* TIMER */
#define AT32F437_MINI_TIMER     3   //use timer 3


/* I2C */
#define AT24_I2C_BUS   3 /* AT24Cxx connected to I2C3 */
#define AT24_MINOR     0    //从设备号

#define PCF8563_BUS    3 /* RTC  */
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the at32f4discovery
 *   board.
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   Called to configure I2S chip select GPIO pins for the at32f4discovery
 *   board.
 *
 ****************************************************************************/
 ...
 *   USB-related GPIO pins for the at32F4Discovery board.
 *
 ****************************************************************************/
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_AT32_AT32F4DISCOVERY_SRC_AT32F4DISCOVERY_H */
